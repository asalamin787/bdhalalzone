                    ...
                    <div class="ec-vendor-dashboard-card space-bottom-30 shadow-sm"
                        ...
                        <div class="container">
                            <div class="btn-group  mt-3 ms-4">
                                <button
                                    class="btn btn-primary btn-sm dropdown-toggle d-flex align-items-center rounded "
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item"
                                            href="{{ route('user.ordersIndex', ['status' => 1]) }}">Paid</a>
                                    </li>
                                    <li><a class="dropdown-item"
                                            href="{{ route('user.ordersIndex', ['status' => 0]) }}">Pending
                                            order</a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ route('user.ordersIndex', ['status' => 2]) }}">On the
                                            way</a>
                                    </li>
                                    <li><a class="dropdown-item"
                                            href="{{ route('user.ordersIndex', ['status' => 3]) }}">Canceled</a>
                                    </li>
                                </ul>
                            </div>
                                                        ...
                                                        <div class="col-md-8 row">
                                                            <div class="col-md-5 center">
                                                                <img class="cart-item-image"
                                                                    src="{{ Storage::url($order->product->getImage()) }}"
                                                                    alt="">
                                                            </div>
                                                            <div class="col-md-6  cart-item-text">
                                                                <a href="{{ route('user.invoice', $order) }}">

                                                                    <h4 class="font-size">{{ $order->product->name }}
                                                                    </h4>
                                                                </a>
                                                                <p class="item-title">
                                                            ...
                                                            <div class="ec-sidebar-block  side-bar-box ">
                                                                ...
                                                                <div class="ec-sb-block-content">
                                                                    <div class=" p-2 border rounded-3">
                                                                        ...
                                                                        <a href="{{ route('user.invoice', $order) }}"
                                                                            class="btn btn-primary w-100 mt-2 mb-2">View
                                                                            Invoice</a>
                                                                        @if ($order->status == 4)
                                                                            <form
                                                                                action="{{ route('user.order.accept', $order) }}"
                                                                                method="post">
                                                                                @csrf
                                                                        ...
                                                                        @if ($order->status == 0 || $order->status == 1)
                                                                            ...
                                                                            @elseif($order->cancel_request == 1)
                                                                                <a href=""
                                                                                    class="btn btn-danger bg-danger text-white mt-2 w-100">Order
                            ...
                            <div class="modal-body">
                                <form id="returnOrderForm" action="" method="post"
                                    ...
                                    <div class="input-group my-3">
                                        ...
                                        <input type="file" name="return_file" class="form-control" style="height: 37px; min-height: 37px" id="inputGroupFile01">
                                    </div>
