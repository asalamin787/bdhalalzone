        ...
        <div class="ec-page-content ec-vendor-uploads section-space-p">
            ...
            <div class="ec-vendor-dashboard-card">
                <div class="ec-vendor-card-body">
                    <form action="{{ route('vendor.product.update', $product) }}" method="post"
                                            ...
                                            <div class="avatar-preview ec-preview">
                                                <div class="imagePreview ec-div-preview">
                                                    <img class="ec-image-preview"
                                                        src="{{ Voyager::image($product->image) }}" alt="edit" />
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <ul class="nav nav-tabs bg-light p-3">
                                    ...
                                    <li class="<?php if (session()->get('target') == 'variation') {
                                        echo 'active';
                                            ...
                                            href="#variable_product_id" id="variation_btn">Variation</a></li>
                                </ul>
