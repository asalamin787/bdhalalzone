                            ...
                            <div class="ec-vendor-block-img space-bottom-30" style="background-color: snow;">
                                ...
                                <div class="ec-vendor-block-detail">
                                    <img class="v-img"
                                        ...
                                        style="object-fit: cover;" alt="E-shop image">
                                        ...
                                        <div class="col-md-6 my-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="paypal_email"
                                                    value="{{ auth()->user()->verification->paypal_email }}"
                                                    placeholder="Paypal email for payouts" name="paypal_email">
                                                @error('paypal_email')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 my-2">
                                            <div class="form-group">
                                                ...
                                                <textarea id="address" placeholder="Address"
                                                    class="form-control mb-3 bg-light @error('address_1') is-invalid @enderror" name="address_1" required>{{ auth()->user()->shopAddress ? auth()->user()->shopAddress->address_1 : '' }}</textarea>
                                        ...
                                        <div class="col-md-6 my-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    value="{{ auth()->user()->shopAddress ? auth()->user()->shopAddress->city : '' }}"
                            ...
                            <div class="row mt-5">
                                <div class="col-md-12">
                                    <div class="ec-vendor-block-profile">
                                        ...
                                        <form class="  " action="{{ route('vendor.shopMenuStore.store') }}"
                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="meta[menuTitle1]"
                                                        value="{{ auth()->user()->shop->menuTitle1 ?? null }}"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="meta[menuLink1]"
                                                        value="{{ auth()->user()->shop->menuLink1 ?? null }}"
                                                        class="form-control @error('meta') is-invalid @enderror"
                                                        id="menuLink1">
                                                ...
                                                <div class="col-md-6 mt-2">
                                                    ...
                                                    <input type="text" name="meta[menuTitle2]"
                                                        value="{{ auth()->user()->shop->menuTitle2 ?? null }}"
                                                        class="form-control @error('meta') is-invalid @enderror"
                                                        id="menuTitle2">
                                                ...
                                                <div class="col-md-6 mt-2">
                                                    ...
                                                    <input type="text" name="meta[menuLink2]"
                                                        value="{{ auth()->user()->shop->menuLink2 ?? null }}"
                                                        class="form-control @error('meta') is-invalid @enderror"
                                                        id="menuLink2">
