    ...
    <div class="ec-shop-rightside col-lg-9 col-md-12">
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <div class=" shadow bg-white p-2 text-center" style="border-radius: 12px;">
                    ...
                    <p style="color: #45464E;font-size: 20px;font-weight: 500;margin-top: 16px">
                        {{ Sohoj::price(auth()->user()->shop->total_withdraw) }}</p>
                    <span class="" style="color:#8B8D97;font-size:14px; "></span>
            ...
            <div class="col-md-4">
                <div class=" shadow bg-white p-2 text-center" style="border-radius: 12px;">
                    ...
                    <p style="color: #45464E;font-size: 20px;font-weight: 500;margin-top: 16px">
                        {{ Sohoj::price(auth()->user()->shop->total_own) }}</p>
                    <span class="" style="color:#8B8D97;font-size:14px; "></span>
          ...
          <div class="alert alert-warning alert-dismissible fade show d-flex justify-content-between" style="background-color: #F8D7DA" role="alert">
            <strong>{{ $error }}
        ...
        <div class="ec-vendor-dashboard-card space-bottom-30">
            <div class="ec-vendor-card-header row">
                ...
                <div class="col-md-3">
                    <button type="button" class="btn btn-primary" {{ auth()->user()->shop->total_own > setting('site.minmum_widthraw_request') ? '' : 'disabled' }}
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content ">
                <form action="{{route('vendor.widthraw.request')}}" method="post">
                    @csrf
