            ...
            <td style="display: block;margin-bottom:30px">
                <table style="width: 100%">
                    ...
                    <td style="text-align: right">
                        <h6 style="font-size: 16px;margin:0px">MYEASYMART</h6>
                        <br>
                        <p style="font-size: 12px;margin:0px">BARISHAL, BANGLADESH</p>
                        {{-- <p>+1 (518) 653-8997</p> --}}
                        <p style="font-size: 12px;margin:0px"> MYEASYMART.com@gmail.com</p>
                    </td>
        </tr>
    </table>
    </td>
            ...
            <table class="order-detail" border="0" cellpadding="0" cellspacing="0" align="left"
                ...
                <tr class="pad-left-right-space ">
                    ...
                    <td class="m-b-5" colspan="2" align="right">
                        <h6 style="font-weight: 400;font-size: 14px; margin: 0;">{{ Sohoj::price($order->platform_fee) }}</h6>
                    </td>
                </tr>
                <tr class="pad-left-right-space ">
                    <td class="m-b-5" colspan="2" align="left">
                ...
                <tr class="pad-left-right-space ">
                    ...
                    <td class="m-b-5" colspan="2" align="right">
                        <h6 style="font-weight: 700;font-size: 14px; margin: 0;">{{ Sohoj::price($order->total + $order->platform_fee) }}</h6>
                    </td>
                </tr>
            </table>
        </td>
                ...
                <tr>
                    <td style="text-align: left">
                        <ul style="font-size:14px">
                            ...
                            <li style="display: block">
                                {{ $order->shop ? $order->shop->city : '' }}, {{ $order->shop ? $order->shop->state :'' }}
                            </li>
                        </ul>
