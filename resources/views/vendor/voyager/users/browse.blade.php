...
@section('page_header')
    <div class="container-fluid">
        ...
        <a href="{{ route('admin.user.pdf', ['key' => request()->key, 'filter' => request()->filter, 's' => request()->s, 'page' => request()->page]) }}"
            class="btn btn-primary">Dawnload PDF</a>
    </div>
@stop
                                ...
                                <tbody>
                                    @foreach ($dataTypeContent as $data)
                                        <tr>
                                            ...
                                            @if ($data->role_id == 4)
                                                <td>
                                                    {{ $data->retailer?->division }}
                                                </td>
                                                <td>
                                                    {{ $data->retailer?->zilla }}
                                                </td>
                                                <td>
                                                    {{ $data->retailer?->upzilla }}
                                                </td>
                                                <td>
