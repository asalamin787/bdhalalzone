                                    ...
                                    @foreach ($dataTypeContent as $data)
                                        <tr>
                                            ...
                                            <td class="no-sort no-click bread-actions">
                                                <a href="{{ route('voyager.products.index', ['key' => 'shop_id', 'filter' => 'contains', 's' => $data->name]) }}"
                                                    class="btn btn-info edit"> Products </a>
                                                @foreach ($actions as $action)
                                                    @if (!method_exists($action, 'massAction'))
                                                ...
                                                <a class="btn btn-sm btn-dark pull-right view " style="margin-right: 5px;"
                                                    href="{{ route('admin.shop.active', $data) }}"><span
                                                        class="hidden-xs hidden-sm "
                                                        style="margin-left: 5px;">{{ $data->status == 0 ? 'Active' : 'Deactive' }}</span></a>
