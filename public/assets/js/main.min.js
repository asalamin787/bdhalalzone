            ...
            a = {
                ...
                initMobileMenu: function () {
                    t(".mobile-menu li, .toggle-menu li").each(function () {
                        ...
                        t(".mobile-menu-container input[name='search']").on("focus", function (e) {
                            var mobileMenu = t('.mobile-menu-wrapper');
                            // Prevent default Android behavior
                            e.preventDefault();
                            // Add class to keep menu open
                            mobileMenu.addClass("keep-open");
                        });
                        t(".mobile-menu-overlay").on("click", function() {
                            setTimeout(function() {
                                if (!mobileMenu.hasClass("keep-open")) {
                                    i(); // Call your close function here
                                }
                            }, 300);  // Delay the closing action slightly
                        });
                        t(".mobile-menu-toggle").on("click", function() {
                            t("body").addClass("menu-open");
                            e(); // Open menu function
                        });
                        
                        t(".mobile-menu-close, .mobile-menu-overlay").on("click", function() {
                            t("body").removeClass("menu-open");
                            i(); // Close menu function
                        });
                                  ...
                                  setTimeout(function () {
                                      i.removeClass(
                                          ...
                                          Wolmart.Minipopup.open({
                                              ...
                                              actionTemplate:
                                                  `<a href="${base_url}/cart" class="btn btn-rounded btn-sm">View Cart</a><a href="${base_url}/checkout" class="btn btn-dark btn-rounded btn-sm">Checkout</a>`,
                                          });
                                  }, 500));
                        }
                    ),
